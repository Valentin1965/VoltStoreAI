      ...
      <section className="relative h-[450px] md:h-[550px] -mt-10 overflow-hidden rounded-[4rem] shadow-3xl">
        ...
        <div className="relative z-20 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          <div className="flex flex-wrap justify-center gap-5">
            ...
            >
              To Catalog <ChevronRight size={18} />
            </button>
            <button 
            ...
            <div className="px-8 py-6 border-b border-slate-100 flex items-center justify-between bg-white shrink-0">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[9px] font-black text-slate-400 uppercase tracking-widest mt-1">Detailed Asset Overview</p>
                </div>
              </div>
               ...
               <div className="flex flex-col lg:flex-row gap-12 mb-16">
                ...
                <div className="lg:w-[45%] flex flex-col gap-8">
                  <div className="bg-slate-50/50 rounded-[3rem] border border-slate-100 p-10 flex flex-col gap-8 shadow-sm">
                    ...
                    <div className="py-8 border-y border-slate-200/60 flex flex-col gap-4">
                      <div className="flex items-center justify-between">
                         <span className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Stock Status:</span>
                         <div className="flex items-center gap-2">
                            <div className={`w-2.5 h-2.5 rounded-full ${isSelectedInactive ? 'bg-amber-500' : 'bg-emerald-500'} shadow-sm animate-pulse`}></div>
                ...
                {selectedProduct.description && (
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 border-b-2 border-slate-100 pb-4">
                      ...
                      <h4 className="text-[12px] font-black text-slate-900 uppercase tracking-[0.2em]">About Product</h4>
                    </div>
                ...
                {filteredSpecs.length > 0 && (
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 border-b-2 border-slate-100 pb-4">
                      ...
                      <h4 className="text-[12px] font-black text-slate-900 uppercase tracking-[0.2em]">Technical Specifications</h4>
                    </div>
                        ...
                        <tbody className="divide-y divide-slate-100">
                          {filteredSpecs.map((spec: ProductSpec, i: number) => (
                            <tr key={i} className="hover:bg-white transition-colors">
                              <td className="p-6 text-[10px] font-black text-slate-400 uppercase tracking-widest w-1/3 border-r border-slate-100/50">{spec.label}</td>
                              <td className="p-6 text-[11px] font-bold text-slate-900 uppercase">{spec.value}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                ...
                {productDocs.length > 0 && (
                  <div className="space-y-6">
                    <div className="flex items-center gap-3 border-b-2 border-slate-100 pb-4">
                      ...
                      <h4 className="text-[12px] font-black text-slate-900 uppercase tracking-[0.2em]">Documentation & Files</h4>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {productDocs.map((doc: ProductDoc, i: number) => (
                        <a 
                          ...
                          className="group p-6 bg-white border border-slate-100 rounded-2xl flex items-center justify-between hover:border-emerald-500 hover:shadow-xl transition-all"
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <span className="text-[11px] font-black text-slate-900 uppercase truncate max-w-[200px]">{doc.title}</span>
                          </div>
